...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
    ...
    <div id="agregarArtículo">
        ...
        <textarea name="" id="" cols="30" rows="5" placeholder="Introducción del Articulo"
        ...
        <textarea name="" id="" cols="30" rows="10" placeholder="Contenido del Articulo"
                  class="form-control"></textarea>
...
<div id="articulo1" class="modal fade">
    ...
    <div class="modal-dialog modal-content">
        ...
        <div class="modal-body" style="border:1px solid #eee">
            ...
            <p class="parrafoContenido">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit
